...
![clear_attributes](https://github.com/EliGale/CML_BreakOUT_UI/blob/main/assets/Clear%20attributes%20-%20CML-BreakOUT-UI.gif)

## How to Use It

1. Fill all the information and click **"Save"**.
...
3. Click **"Open"** will open the default  web page "http://[::1]:8080/#/". By default port 8080 is the default local port. **Do not confuse this with the port provided when filling the box information fields**.

4. In the web page opened for the service, **click at the top right refresh button"**.  
